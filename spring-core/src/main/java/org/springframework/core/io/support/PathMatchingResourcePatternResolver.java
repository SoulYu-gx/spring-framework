...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	/**
	 * 创建 路径模式资源解析器，并设置资源解析器为 当前上下文对象
	 * @param resourceLoader 指定资源解析器（当前上下文对象）
	 */
	...
	/**
	 * 从 资源位置 获得一个 resource数组
	 * @param locationPattern 资源位置
	 * @return
	 * @throws IOException
	 */
	@Override
